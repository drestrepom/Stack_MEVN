    ...
    <div class="modal" :class="{ 'is-active': isActive }">
      ...
      <div class="modal-card">
        ...
        <section class="modal-card-body">
          ...
          <button @click="update" class="button is-primary is-pulled-right">Actualizar</button>
        </section>
      </div>
      <button @click="toggle" class="modal-close is-large" aria-label="close">Actualizar</button>
    </div>
    <button @click="toggle" class="button is-small is-pulled-right">Actualizar</button>
  </div>
</template>
